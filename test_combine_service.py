from model.object_detection_service import object_detection
from preprocess.crop_service import crop
from preprocess.deskew import rotateImg, rotateBarcode
from preprocess.tesseract import tesseract
from model.classification import classify, setup_classifier
import fire
...
##    print('sucessfully loaded the model')
    if address:
        ...
        resource_info['memory'] = '{}MB'.format(process.memory_info().rss/1024/1024)
        resource_info['time'] = '{}s'.format(end_time-start_time)
